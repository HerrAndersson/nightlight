...
{
	gameObject.push_back(new GameObject(XMMatrixIdentity(), Assets->renderObjects.at(4), XMFLOAT3(0, 0, 0), XMFLOAT3(0, 0, 0)));
	gameObject.push_back(new GameObject(XMMatrixIdentity(), Assets->renderObjects.at(2), XMFLOAT3(0, 0, 0), XMFLOAT3(0, 0, 0)));
}
